...
return [
    ...
    */
    ...
    'bread' => [
        ...
        // BREAD 作成フォームのデフォルト値（新規作成時のみ反映）
        'create_defaults' => [
            'controller' => 'App\\Http\\Controllers\\VoyagerBaseController'
        ],
    ],
    ...
    */
    ...
    'googlemaps' => [
        ...
        'center' => [
            'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '34.702485'),
            'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '135.495951'),
        ],
